...
# Urgency dynamics (EXPLICIT)
URGENCY_RISE = 0.001      # per step under pressure
URGENCY_DECAY = 0.0002   # per step when pressure eases
...
def main():
    print("=== SALIENCE × VALUE × URGENCY (CONVERGENCE TEST) ===")
    ...
    if records:
        ...
        print("no urgency recorded (ERROR)")
