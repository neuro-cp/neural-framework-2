...
from learning.diffing.learning_bundle_diff_serializer import serialize_diff
...
def test_learning_bundle_diff_serialization_is_stable():
    ...
    out1 = serialize_diff(diff)
    out2 = serialize_diff(diff)
