...
def test_learning_bundle_diff_read_only_and_deterministic():
    ...
    diff1 = diff_learning_bundles(bundle_a, bundle_b)
    diff2 = diff_learning_bundles(bundle_a, bundle_b)

    assert diff1 == diff2
    assert diff1.has_difference is True
